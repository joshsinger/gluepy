...
'''
import unittest
from gluepy.translation import ambig_triplet_to_result
...
class Test(unittest.TestCase):
    ...
    def test1(self):
        result = ambig_triplet_to_result['YAY']
    ...
    def test2(self):
        result = ambig_triplet_to_result['TSR']
        self.assertEquals(result.aa, 'X')
    ...
    def test3(self):
        result = ambig_triplet_to_result['ACN']
    ...
    def test4(self):
        result = ambig_triplet_to_result['ANN']
        self.assertEquals(result.aa, 'X')
